...
class Model {
  ...
  constructor (value, endPoint, resourceName, options) {
    ...
    this.$instanceKeywords = [
      ...
      '$clean', '$parseRequest', '$instanceKeywords', '$http'
    ]
  }
  ...
  $post = (request) => {
    ...
    return new Promise((resolve, reject) => {
      ...
      instance.$http.post(request.endPoint, request.resource).then((response) => {
  ...
  $destroy = () => {
    ...
    let instance = this
    return new Promise((resolve, reject) => {
      instance.$http.delete(destroyEndPoint).then((response) => {
  ...
  $update = () => {
    ...
    return new Promise((resolve, reject) => {
      instance.$http.put(updateEndPoint, request.resource).then((response) => {
        if (instance.$options.transformResponse) {
          instance.$options.transformResponse(response)
        }
        if (response.data) {
